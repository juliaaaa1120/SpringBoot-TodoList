...
//        Todo todo1 = new Todo(null, "Julia", 18, "Female", company.getId().toString(), 100000);
//        todoRepositoryInMongo.insert(todo1);
//        Todo todo2 = new Todo(null, "Jason", 18, "Male", company.getId().toString(), 100000);
//        todoRepositoryInMongo.insert(todo2);
//        Todo todo3 = new Todo(null, "Klaus", 18, "Male", company.getId().toString(),100000);
...
//                .andExpect(jsonPath("$[0].employees[*].id").value(containsInAnyOrder(todo1.getId(), todo2.getId(), todo3.getId())))
...
//        Todo todo1 = new Todo(null, "Julia", 18, "Female", company1.getId().toString(), 100000);
//        todoRepositoryInMongo.insert(todo1);
//        Todo todo2 = new Todo(null, "Jason", 18, "Male",company1.getId().toString(), 100000);
//        todoRepositoryInMongo.insert(todo2);
//        Todo todo3 = new Todo(null, "Klaus", 18, "Male", company2.getId().toString(),100000);
//        todoRepositoryInMongo.insert(todo3);
//
//        //when
...
//                .andExpect(jsonPath("$.employeeResponses[0].id").value(todo3.getId()))
...
//                .andExpect(jsonPath("$[*].id").value(containsInAnyOrder(todo1.getId(), todo2.getId())))
...
//        Todo todo1 = new Todo(null, "Julia", 18, "Female",company1.getId().toString(), 100000);
//        todoRepositoryInMongo.insert(todo1);
//        Todo todo2 = new Todo(null, "Jason", 18, "Male",company2.getId().toString(), 100000);
//        todoRepositoryInMongo.insert(todo2);
//        Todo todo3 = new Todo(null, "Klaus", 18, "Male", company3.getId().toString(),100000);
//        todoRepositoryInMongo.insert(todo3);
//        Todo todo4 = new Todo(null, "Gloria", 18, "Female", company4.getId().toString(),100000);
...
//                .andExpect(jsonPath("$[*].employees[*].id").value(containsInAnyOrder(todo3.getId(), todo4.getId())))
...
//                .andExpect(jsonPath("$.employees[*].id").value(containsInAnyOrder(todo1.getId(), todo2.getId(), todo3.getId())))
